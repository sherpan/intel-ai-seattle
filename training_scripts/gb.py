...
#initialize model
model = GradientBoostingClassifier(learning_rate=hyper_params['learning_rate'], n_estimators=hyper_params['n_estimators'])
...
log_model(experiment, "my-gb-model", model)