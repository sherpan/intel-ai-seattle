...
#initialize model
model = AdaBoostClassifier(learning_rate=hyper_params['learning_rate'], n_estimators=hyper_params['n_estimators'])
...
log_model(experiment, "my-ada-model", model)